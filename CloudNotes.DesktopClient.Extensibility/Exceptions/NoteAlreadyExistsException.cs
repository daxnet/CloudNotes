...
namespace CloudNotes.DesktopClient.Extensibility.Exceptions
{
    ...
    /// <summary>
    /// Represents the exception that occurs when the note has already been existed.
    /// </summary>
    public sealed class NoteAlreadyExistsException : ApplicationException
    {
        #region Ctor
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteAlreadyExistsException"/> class.
        /// </summary>
