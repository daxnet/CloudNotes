...
namespace CloudNotes.DesktopClient.Extensions.Exporters
{
    ...
    /// <summary>
    ///     Represents the extension that exports the current note to an external text file.
    /// </summary>
    ...
    public sealed class TextFileExporter : ExportExtension
    {
        ...
        {
            get { return new TextFileExporterOptionDialog(); }
        }
        ...
        {
            get { return Resources.TextFileExporterDisplayName; }
        }
        ...
        {
            get { return Resources.TextFileExporterDescription; }
        }
